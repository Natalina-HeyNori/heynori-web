...
import { Mail, Heart, ArrowUp, Github, Twitter, Linkedin, MessageCircle } from 'lucide-react'
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: t('footer.sections.product.features'), href: '#benefits' },
    ...
    },
    {
      ...
      links: [
        { name: t('footer.sections.company.about'), href: '#problems' },
    ...
    },
    {
      ...
      links: [
        { name: t('footer.sections.support.helpCenter'), href: '#contact' },
        { name: t('footer.sections.support.contact'), href: '#contact' }
      ]
    }
  ]

  const socialLinks = [
    { icon: Twitter, href: 'https://x.com/heynoriHQ', label: t('footer.social.twitter') },
    { icon: Linkedin, href: 'https://www.linkedin.com/company/heynori/posts/?feedView=all', label: t('footer.social.linkedin') }
  ]
